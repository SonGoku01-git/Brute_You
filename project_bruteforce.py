...
if protocol == "http":
    ...
    user_field = input("Enter the username field name: ")
    pass_field = input("Enter the password field name: ")
    failure_indicator = input("Enter a word that indicates login failed (e.g., 'invalid'): ")
else:
